...
module.exports = {
    insertCust: function(body){
        ...
        conn.connect((err) => {
            ...
            var data = [null, body.firstname, body.lastname, body.address, body.city, body.province, body.postalCode, body.country, body.homeNum, body.busNum, body.email, 1, body.password];
